...
'presentation' => array(
    totranslate('Volcano is a puzzle game inspired by the spewing eruptions of volcanoes. Stacks of colorful pyramid pieces represent mountaintops. Players move special pieces among the mountains, sometimes triggering volcanic erruptions. During an eruption, the stacked pieces "flow" onto other stacks, and adjacent same-size pieces are captured. Players win by capturing matching sets of pieces.')
),
